...
if (!(workoutSetsHasColumn('is_global') && workoutSetsHasColumn('description'))) {
    ...
    echo '<div class="alert alert-warning mt-4">Nejdříve spusťte migraci <code>scripts/migrate_global_workout_sets.php</code>.</div>';
    renderAdminFooter();
    exit;
}
...
renderAdminHeader('Globální sady');
?>
<div class="d-flex justify-content-between align-items-center mb-4"><h2 class="mb-0"><i class="fas fa-layer-group me-2 text-warning"></i>Globální sady</h2><a class="btn btn-outline-secondary btn-sm" href="<?= BASE_URL ?>/scripts/migrate_global_workout_sets.php" target="_blank">Migrace</a></div>
