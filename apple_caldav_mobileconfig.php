...
$mobileConfig = buildAppleCaldavMobileConfig([
	'profile_display_name' => 'TrainerApp - Apple Kalendar (Trener)',
	'profile_description' => 'Automaticke nastaveni Apple CalDAV pro TrainerApp ucet trenera.',
	'payload_identifier' => 'online.reservio.trainerapp.coach.' . $coachId . '.caldav',
	'account_description' => 'TrainerApp Trener',
	'host_name' => $host,
	'port' => $port,
	'principal_url' => $path,
	'username' => $username,
...
$filename = 'trainerapp-coach-' . $coachId . '-caldav.mobileconfig';
