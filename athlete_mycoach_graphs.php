...
$sleepValues = array_map(static function (array $row): float {
    return isset($row['sleep_hours']) ? (float)$row['sleep_hours'] : 0.0;
}, $timeline);
...
<div class="row g-4 mb-4">
    <div class="col-12">
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-dark text-white fw-bold"><i class="fas fa-chart-line me-2 text-warning"></i>Readiness a subjektivní stav</div>
    ...
    <div class="col-12 col-xl-6">
        <div class="card border-0 shadow-sm h-100">
            <div class="card-header bg-dark text-white fw-bold"><i class="fas fa-bed me-2 text-warning"></i>Spánek a readiness trend</div>
...
const sleepValues = <?= json_encode($sleepValues, JSON_UNESCAPED_UNICODE) ?>;
...
new Chart(document.getElementById('sleepChart'), {
    ...
    options: { responsive: true, maintainAspectRatio: false, scales: { y: { beginAtZero: true, max: 12 } } }
});
</script>
<?php endif; ?>
