...
<div class="card border-0 shadow-sm mb-4">
    <div class="card-body py-3">
        <p class="mb-0">Vyplněním dotazníku uložíš vstupní údaje, vytvoříš první aktivní plán a nastavíš základ pro další doporučení. Pokud je cílem HYROX, odemknou se navíc závodní otázky.</p>
    </div>
</div>
