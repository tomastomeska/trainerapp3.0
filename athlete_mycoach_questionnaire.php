            ...
            if (!isset($goalOptions[$goalType])) {
                ...
                try {
                    ...
                    if ($existingSimilarGoal) {
                        ...
                        redirect(BASE_URL . '/athlete_mycoach_questionnaire.php');
                    }
...
<div class="card border-0 shadow-sm mb-4">
    <div class="card-body py-3">
        <p class="mb-2">Dotazník vyplň jednou a uloží se i jako startovní plán. Formulář si navíc průběžně drží draft, takže při výpadku internetu nepřijdeš o rozpracovaná data.</p>
